...
-- Adapted to read from: public.icd_9_sepsis
--
-- INPUT TABLE REQUIREMENTS (must exist):
--   public.icd_9_sepsis with columns:
--     hadm_id, seq_num, icd9_code, icd_version
--
-- OUTPUT:
